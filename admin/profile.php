...
<body>
	...
	<ul class="nav">
					...
					<li>
				<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="fa fa-envelope"></i> <span>Surat Masuk</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
				<div id="subPages" class="collapse ">
					<ul class="nav">
													<li><a href="lihat-surat-masuk.php" class="">Lihat Surat Masuk</a></li>
													<li><a href="cari-surat-masuk.php" class="">Cari Surat Masuk</a></li>
											</ul>
				</div>
			</li>

			<li>
				<a href="#subPages2" data-toggle="collapse" class="collapsed"><i class="fa fa-paper-plane-o"></i> <span>Surat Keluar</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
				<div id="subPages2" class="collapse ">
					<ul class="nav">
													<li><a href="lihat-surat-keluar.php" class="">Lihat Surat Keluar</a></li>
													<li><a href="cari-surat-keluar.php" class="">Cari Surat Keluar</a></li>
											</ul>
				</div>
			</li>
