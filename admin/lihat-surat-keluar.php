...
<ul class="nav">
	...
	<h3 class="page-title"><i class="fa fa-paper-plane-o"></i>  Data Penduduk</h3>
	<div class="panel panel-headline demo-icons">
		...
		<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Data Penduduk</button> 
		<br/>
		<br/>
		<br/>
