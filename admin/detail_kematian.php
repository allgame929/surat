...
<a class="btn" href="kematian.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
<?php
...
?>					
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		...
		<tr>
			<td>Pendidikan dalam Kartu Keluarga</td>
			<td><?php echo $d['Pendidikan_dalam_KK'] ?></td>
		</tr>
		<tr>
			<td>Pendidikan sedang ditempuh</td>
			<td><?php echo $d['Pendidikan_sedang_ditempuh'] ?></td>
		</tr>
		<tr>
			<td>Pekerjaan</td>
